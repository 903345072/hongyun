	...
	<view>
		...
		<view style="display: flex;flex-direction: column;align-items: center;margin-top: -150rpx;z-index: 999999999;position: relative;">
			...
			<view
			                ...
			                <view style="display: flex;align-items: center;justify-content: space-between;">
			                	<view>是否需上传票据</view>
			                	<view style="color: #323232;">{{orderdetail.is_upload == 1?'需要':'不需要'}}</view>
			                </view>  
							<view style="display: flex;align-items: center;justify-content: space-between;">
								<view>付款时间</view>
						...
						<view style="padding: 20rpx 40rpx;">
							*请您务必仔细核对实体票方案,若有误请在<text style="color: red;">出票时间截止前</text>联系店家申述，否则开奖后因错票引起的纠纷由您自行承担。<text style="color: red;">联系店主申诉</text>
						</view>
						...
						<view v-if="orderdetail.order_detail_.length==0">
							...
							<view>
								<view style="margin-top: 100rpx;font-size: 30rpx;font-weight: bold;">开赛后可见</view>
							</view>
