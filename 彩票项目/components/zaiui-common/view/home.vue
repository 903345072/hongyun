	...
	<view class="zaiui-home-box" :class="show?'show':''">
				...
				<view >
					<view style="margin-left: 30rpx;">
						...
						<view style="display: flex;margin-top:30rpx">
							...
							<view @click="complain()" style="background-color: #8ac1fa;margin-left:20rpx;height: 45rpx;line-height: 45rpx;border-radius: 90rpx;padding: 0 20rpx;">
		...
		<view style="box-shadow: 5rpx 5rpx 10rpx #CCCCCC;color: white;padding: 25rpx 20rpx;margin: 10rpx 20rpx;margin-top: 30rpx;border-radius: 20rpx;">
			...
			<view style="display: flex;justify-content: space-around;margin-top: 15rpx;">
				...
				<!-- <view @tap="toGuanYa"  style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
		...
		<uni-popup ref="popup" :mask-click="true" type="top"  style="z-index: 999999999;left: 50%;top: 10%;"  >
			...
			<view @click="closeMask()"  style="width: 100%;display: flex;justify-content: center;align-items: center;position: relative;">
				...
				<view style="position: absolute;bottom: -40rpx;">截图保存,点击关闭</view>
			</view>
