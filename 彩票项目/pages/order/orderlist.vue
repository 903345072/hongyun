								...
								<view style="display: flex;align-items: center;">
									...
									<view style="display: flex;flex-direction: column;justify-content: center;align-items: flex-start;">
										<view :style="{color:item.state==2 || item.state==3?'red':'#797374','font-weight':'bold'}">
											{{item.en_state}}
											<text style="background-color: #df0edc;border-radius: 25rpx;font-size: 20rpx;height: 35rpx;text-align: center;line-height: 35rpx;color: white;padding: 0 10rpx;margin-left: 10rpx;">{{item.en_mode}}</text>
										</view>
