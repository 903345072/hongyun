<template>
	<view>
		...
		<view style="padding: 20rpx 20rpx;">清除订单数据(不清除不要选择月份)</view>
		
		
		<view class="cu-list menu margin-top">
			<view class="cu-item">
				<view class="content">几月之前</view>
				<view>
					<text @tap="changeType(item)" :class="['check_list',{'checked_':month == item},{'unchecked':month != item}]" v-for="(item,index) in mothiList">
						{{item}}月
					</text>
				</view>
			</view>
